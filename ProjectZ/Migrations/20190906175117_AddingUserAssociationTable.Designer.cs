...
namespace ProjectZ.Migrations
{
    ...
    [Migration("20190906175117_AddingUserAssociationTable")]
    partial class AddingUserAssociationTable
    {
            ...
            modelBuilder.Entity("ProjectZ.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = new byte[] { 195, 20, 62, 133, 41, 157, 161, 77, 155, 3, 104, 160, 138, 8, 115, 181, 204, 61, 25, 96 },
                            PasswordSalt = new byte[] { 165, 251, 17, 114, 27, 114, 0, 74, 81, 106, 36, 222, 69, 163, 241, 52 }
                        });
                });
